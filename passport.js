...
function renderPassport(student) {
  ...
  if (badgeList) {
    // Keep the Achievements panel focused only on badges already unlocked.
    // Locked achievements are already visible in the My Digital Journey list.
    ...
    badgeList.innerHTML = unlocked || `
      <div class="badge-empty">
        <div class="badge-empty-symbol">🔒</div>
        <b>No badges unlocked yet</b>
        <small>Complete your first Digital Mission to unlock a badge.</small>
      </div>`;
  }
